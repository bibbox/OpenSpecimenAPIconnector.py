...
class execute_mapping:
    ...
    def run(self):
        ...
        mappings = bbmri_mapping()

        persons_extensions = mappings.person_extension()
        person_map = mappings.person_map()

        biobank_extensions = mappings.biobank_extension()
        print(biobank_extensions)
        biobank_map = mappings.biobank_map()

        collection_map = mappings.collection_map()
