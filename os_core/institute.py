...
class institutes():
    ...
    def delete_institute(self, inid):
        ...
        ---------
        inid : string or int
            🤦‍♀️The System generated ID of the Institute. Will get converted to a string.
    ...
    def search_institutes(self, substring):
        ...
        Search for one or more institutes with the substring in their name 🤦‍♀️defined. The search URL looks like:
