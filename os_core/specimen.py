...
class specimen:
    ...
    search specimens with different parameters and can get all specimens in the system.
    The output is a JSON dict or the error message as dict. 🤦‍♀️It also can check if a
